...
public class KakaoOauthService {
    private String REST_API_KEY = "fce6812535f3d9c2d7ff42701dbe504d";
    private String REDIRECT_URI = "http://localhost:8080/kakao/login";

    public String getAccessToken(String authorize_code) {
        String access_Token = ""; // 짧은 토큰
        String refresh_Token = ""; // 긴 토큰
        String reqURL = "https://kauth.kakao.com/oauth/token"; // 카카오 API
